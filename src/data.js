...
export const hero = {
  title: 'Welcome to Benbare Furniture: Where Comfort Meets Style',
  subtitle:
    'Elevating Spaces, Enriching Lives: Benbare Furniture, Where Every Piece Tells a Story of Style and Comfort.',
  buttonText: 'Shop Now',
};
...
export const products = {
  title: 'All Products',
  subtitle:
    'The products we provide only for you as our service are selected from the best products with number one quality in the world',
  pages: [
    {
      productList: [
        {
  ...
  persons: [
    {
      ...
      message:
        '“Absolutely thrilled with my experience shopping at BenBare!”',
    },
    {
      avatar: <Avatar2Img />,
      ...
      occupation: 'Manager of The New York Times',
      message:
        '“The quality of the furniture exceeded my expectations, and the prices were unbeatable.”',
    },
    {
      avatar: <Avatar3Img />,
      name: 'Paula Simon',
      occupation: 'Manager of The New York Times',
      message:
        '“ I will definitely be recommending BenBare Furniture to all my F&F looking to furnish their homes with style!”',
    },
    {
      avatar: <Avatar4Img />,
      name: 'Greg Thompson',
      occupation: 'Manager of The New York Times',
      message:
        '“The delivery was prompt and hassle-free, and the customer service team was incredibly helpful and responsive. ”',
    },
  ],
};
...
export const footer = {
  ...
  copyright: 'Ben-Bare 2024 - All Rights Reserved.',
};
